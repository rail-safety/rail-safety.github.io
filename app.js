...
function applyCurrentRiskTheme(level) {
const card = document.querySelector(".status-card");
card.style.setProperty("--hero-risk", level.color);
card.style.setProperty("--hero-risk-dark", level.dark);
card.style.setProperty("--hero-risk-soft", level.soft);
}
...
state.hourly = [];
applyCurrentRiskTheme({ color: "#697887", dark: "#42515f", soft: "#eef2f5" });
